...
public interface IReadingService
{
    ...
    Task<IReadOnlyList<ReadingBatch>> GetBatchesAsync(Guid deviceId, int page, int pageSize, CancellationToken ct = default);
    Task<ReadingBatch?> GetLatestBatchAsync(Guid deviceId, CancellationToken ct = default);
}